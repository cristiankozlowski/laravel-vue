    ...
    inputSearch: function inputSearch() {
      ...
      if (this.filterTerm.length > 3) {
        this.list = this.list.filter(function (user) {
          return user.name.indexOf(_this.filterTerm) !== -1 || user.email.indexOf(_this.filterTerm) !== -1;
        });
      }
    }
  },
...
var render = function() {
  ...
  return _c("div", [
    _c("div", { staticClass: "card card-body bg-light mb-5" }, [
      _c("input", {
        directives: [
          {
            name: "model",
        ...
        attrs: { type: "text", placeholder: "Filtre por nome ou e-mail" },
        domProps: { value: _vm.filterTerm },
        on: {
          keyup: _vm.inputSearch,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_UsersTable_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/UsersTable.vue */ "./resources/js/components/UsersTable.vue");
...
new Vue({
  el: '#app',
  components: {
    UsersTable: _components_UsersTable_vue__WEBPACK_IMPORTED_MODULE_0__["default"]
  }
});
